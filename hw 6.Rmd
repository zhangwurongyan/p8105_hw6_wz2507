...
The model has $R^2$ of 0.718 which means 71.8% of the variablity of birthweight was explained by the model.
The relationship between residuals and fitted values are not clear as we can see from the plot above.
